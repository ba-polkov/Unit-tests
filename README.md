...
# Для метода set_book_genre и get_book_genre 
# test_set_and_get_book_genre_success - Установка и получение жанра книги 
...
# get_books_with_specific_genre_return_corrrect_list - проверка получения книг с определенным жанром 
...
# Для методов add_book_in_favorites, delete_book_from_favorites, get_list_of_favorites_books
